...
export function LoginForm({
  ...
  return (
    <form
      ...
      className="h-full w-full max-lg:w-screen flex flex-col py-4 px-20 justify-center max-sm:px-4 max-lg:px-10 items-center data-[is-login=true]:translate-x-[100%] max-lg:data-[is-login=true]:translate-x-[0%] max-lg:data-[is-login=false]:-translate-x-[100%] ease-in-out duration-150"
    >
