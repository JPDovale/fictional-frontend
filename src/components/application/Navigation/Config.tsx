...
export const configContentStyle = tv({
  base: 'data-[state=open]:animate-contentShow absolute w-[30%] max-sm:w-[90%] max-lg:w-[80%] h-[70%] top-[50%] left-[50%] translate-x-[-50%] rounded-md border border-purple900 shadow-2xl shadow-black translate-y-[-50%] z-[101]',
  variants: {
    theme: {
